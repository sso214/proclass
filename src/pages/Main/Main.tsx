      ...
      <main css={S.wrapper}>
        ...
        <div css={S.container}>
          ...
          <section css={S.section02}>
            <article>
              <h2 css={S.title}>
                임직원 교육을 <br className='mo' />고민하는 순간,<br/>
                <span>회사의 성장은 <br className='mo' />시작됐습니다.</span>
              </h2>
            </article>
          </section>
              ...
              <ol className='worryList' data-aos="fade-up" data-aos-delay="300">
                {[
                  ...
                  },
                  {
                    ...
                    el: (
                        <>
                          <span style={{color: '#7140FF'}}>높은 인력 분산도로</span><br/>
                          교육 운영 자체가 어려워요
                        </>
                    )
                  },
                  {
                    ...
                    el: (
                        <>
                          <span style={{color: '#1D5CFF'}}>급변하는 경영환경에 적합한</span><br/>
                          교육 내용이 필요해요
                        </>
                    )
                  },
                ...
                {[
                  ...
                  <>
                    ...
                    <li key={index}>
                      ...
                      {index === 0 && (
                        <p className='guide'>📚 지금 도입하면 법정필수교육 무료 제공!</p>
                      )}
                    </li>
                ))}
              </ol>
          ...
          <section css={S.section04}>
            <article>
              <h3>
                프로클래스와 만나세요.<br/>
                생성형 AI와 러닝저니로 <br className='mo'/>더욱 새로워진 성장 경험을.
              </h3>
            </article>
          </section>
          ...
          <section css={S.section05}>
            <article>
              <div className='title' data-aos="fade-up">
                ...
                <h2 css={S.title}>
                  시공간 제약 없이 <br className='mo'/>다양한 교육 형태를 결합한<br/>
                  몰입형 러닝저니를 <br className='mo'/>구현합니다.
                </h2>
              </div>
            ...
            <article>
              <div className='title' data-aos="fade-up" data-aos-delay="900">
                ...
                <h2 css={S.title}>
                  생성형 AI 적용으로 <br className='mo'/>오직 개인을 위한<br/>
                  러닝 플레이를 선사합니다.
                </h2>
              </div>
              <ol className='mockupList'>
            ...
            <article>
              <div className='title' data-aos="fade-up" data-aos-delay="1800">
                ...
                <h2 css={S.title}>
                  독려가 필요 없는 학습 몰입.<br/>
                  프로클래스의 <br className='mo'/>최종 목적지입니다.
                </h2>
              </div>
